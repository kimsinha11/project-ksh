...
<div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white"  style="height:600px;">
        <div class="option">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9bb17291c4509304be1b5fc5f66ba703&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
